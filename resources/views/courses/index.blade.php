      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 blog-pull-right">
            <div class="row">
              <div class="course-single-item clearfix mb-30">
                <div class="col-sm-6 col-md-5">
                  <div class="course-thumb">
                  <img class="img-fullwidth" alt="" src="http://placehold.it/335x232">
                ...
                <div class="col-sm-6 col-md-7">
                  <h4 class="line-bottom-theme-colored2 mt-0 mb-15 mt-sm-20">Web Development</h4>
                  <ul class="mb-10">
                    <li><h4 class="mt-0 mb-5">Price :<span class="text-theme-colored2"> $320</span></h4></li>
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia iste illum deserunt quo eligendi facere, veritatis tempore labore, eveniet error inventore at nesciunt dolore accusamus.</p>
                  <a class="btn btn-default btn-sm text-uppercase mt-5" href="#">view details</a>
                </div>
              </div>
              <div class="course-single-item clearfix mb-30">
                <div class="col-sm-6 col-md-5">
