...
<footer id="footer" class="footer" data-bg-color="#20232E">
    <div class="container pt-60 pb-20">
        <div class="col-sm-6 col-md-3">
            <div class="widget dark">
                ...
                <ul class="list-inline">
                    <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone mr-5"></i> <a href="#">123-456-789</a>
                    </li>
                    <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o mr-5"></i> <a
                            href="mail:samir.belghol@gmail.com">prestavert@gmail.com</a> </li>
                    <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe mr-5"></i> <a
                            href="https://prestavert.com">wwww.prestavert.com</a> </li>
                </ul>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="widget dark">
                <h4 class="widget-title line-bottom-theme-colored2">Autres</h4>
                <div class="row clearfix">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <ul class="footer-link">
                            <li><a href="{{ route('evenement.index') }}">Recherche</a></li>
