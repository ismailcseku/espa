          ...
          <div class="row multi-row-clearfix">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div class="event-grid bg-silver-light maxwidth500 mb-30">
                <div class="thumb">
                  <img src="{{url('storage').'/'.$evenement->photo}}" alt="" class="img-fullwidth">
                  <div class="entry-date media-left text-center flip">
                    <ul>
                      <li class="font-16 text-white font-weight-600 line-height-1">@php
                ...
                <div class="event-grid-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                  <h5 class="text-uppercase font-weight-600 font-18 mb-10">{{$evenement->title}}</h5>
                  <ul class="font-14">
                    <li> <i class="fa fa-map-marker text-theme-colored2"></i> {{$evenement->location}}</li>
