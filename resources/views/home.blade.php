...
<div class="main-content">
        ...
        <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
          <ul>
            ...
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide One">
              <!-- MAIN IMAGE -->
              <img src="http://placehold.it/1920x1280" alt="" data-bgposition="center 20%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <!-- LAYERS -->
              <!-- LAYER NR. 1 -->
              ...
              <div class="tp-caption tp-resizeme text-white text-uppercase font-montserrat rs-parallaxlevel-0" 
                ...
                data-splitout="none"
                data-responsive_offset="on"
                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Popular Education
              </div>
              <!-- LAYER NR. 3 -->
              <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                id="slide-1-layer-3" 
                ...
                data-splitout="none" 
                data-responsive_offset="on" 
                style="z-index: 7; white-space: nowrap;">We provides always our best services for our students and  always<br> try to achieve making a bright successful future.
              </div>
              <!-- LAYER NR. 4 -->
              <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                id="slide-1-layer-4" 
                ...
                data-splitout="none" 
                data-responsive_offset="on" 
                style="z-index: 7; white-space: nowrap;"><a href="#" class="btn btn-dark btn-circled btn-theme-colored2 btn-xl mr-10 pr-30 pl-30">Démarrer</a> <a href="#" class="btn btn-transparent btn-border btn-circled btn-xl pr-30 pl-30">M'inscrire</a>
              </div>
            </li>
            <!-- SLIDE 2 -->
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide Two">
              <!-- MAIN IMAGE -->
              <img src="http://placehold.it/1920x1280" alt="" data-bgposition="center 20%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <!-- LAYERS -->
              <!-- LAYER NR. 1 -->
              ...
              <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                ...
                data-splitout="none" 
                data-responsive_offset="on" 
                style="z-index: 7; white-space: nowrap;"><a href="#" class="btn btn-dark btn-circled btn-theme-colored2 btn-xl mr-10 pr-30 pl-30">Start Now</a> <a href="#" class="btn btn-transparent btn-border btn-circled btn-xl pr-30 pl-30">M'inscrire</a>
              </div>
            </li>
            <!-- SLIDE 3 -->
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide Three">
              <!-- MAIN IMAGE -->
              <img src="http://placehold.it/1920x1280" alt="" data-bgposition="center 20%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <!-- LAYERS -->
              <!-- LAYER NR. 1 -->
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group mb-20">
                      <input placeholder="Votre nom" id="reservation_name" name="reservation_name" required="" class="form-control" aria-required="true" type="text">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      <input placeholder="Email" id="reservation_email" name="Votre email" class="form-control" required="" aria-required="true" type="text">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      <input placeholder="Phone" id="reservation_phone" name="téléphone" class="form-control" required="" aria-required="true" type="text">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      <input name="Date Of Birth" class="form-control required date-picker" placeholder="Date de naissance" aria-required="true" type="text">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group mb-0 mt-10">
                      <input name="form_botcheck" class="form-control" value="" type="hidden">
                      <button type="submit" class="btn btn-colored btn-theme-colored2 text-white btn-lg btn-block" data-loading-text="Please wait...">je choisis</button>
                    </div>
                  </div>
                </div>
              </form>
  ...
  <section id="courses" class="bg-silver-light">
    <div class="container">
      <div class="section-title mb-40">
        <div class="row">
          <div class="col-md-12">
            <h2 class="title text-uppercase mb-5">Cours <span class="text-theme-colored2">Populaire</span></h2>
    ...
    <div class="container pt-50 pb-40">
      <div class="section-title">
        <div class="row">
          ...
          <div class="col-lg-4">
            <h3 class="font-28 mt-md-30 mt-0"><span class="text-theme-colored2">Évènements</span> à venir </h3>
            <div class="line-bottom-theme-colored2"></div>
            <article>
              <div class="event-small media sm-maxwidth400 bg-silver-light border-1px mt-0 mb-20 p-15">
                ...
                <div class="event-content pt-5">
                  <h5 class="media-heading font-16 mb-5"><a class="font-weight-600" href="#">Admission Fair Spring 2017</a></h5>
            ...
            <article>
              <div class="event-small media sm-maxwidth400 bg-silver-light border-1px mt-0 mb-20 p-15">
                ...
                <div class="event-content pt-5">
                  <h5 class="media-heading font-16 mb-5"><a class="font-weight-600" href="#">Learning Spoken English</a></h5>
                  <span class="mr-10"><i class="fa fa-clock-o text-theme-colored2"></i> 5.00 pm - 7.30 pm</span>
            ...
            <article>
              <div class="event-small media sm-maxwidth400 bg-silver-light border-1px mt-0 mb-20 p-15">
                ...
                <div class="event-content pt-5">
                  <h5 class="media-heading font-16 mb-5"><a class="font-weight-600" href="#">Workshop Online Marketing</a></h5>
                  <span class="mr-10"><i class="fa fa-clock-o text-theme-colored2"></i> 5.00 pm - 7.30 pm</span>
          ...
          <div class="col-lg-4">
            <h3 class="font-28 mt-md-30 mt-0"><span class="text-theme-colored2">Pourquoi </span>Nous? </h3>
            <div class="line-bottom-theme-colored2"></div>
  ...
  <section id="team">
    <div class="container">
      <div class="section-title mb-40">
        <div class="row">
          <div class="col-md-12">
            <h2 class="title text-uppercase mb-5">Nos  <span class="text-theme-colored2">professeurs</span></h2>
            <h5 class="font-16 text-gray-darkgray mt-5">Discuter avec un professeur </h5>
          </div>
        </div>
      </div>
      <div class="section-content">
            ...
            <div class="team-members mb-40">
              ...
              <div class="team-bottom-part border-1px p-15">
                ...
                <ul class="list-inline mt-15">
                  <li class="m-0 pr-10"> <i class="fa fa-phone text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">123-456-789</a> </li>
                  <li class="m-0 pr-10"> <i class="fa fa-envelope-o text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">contact@yourdomain.com</a> </li>
                  <li class="m-0 pr-10"> <i class="fa fa-globe text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">www.yourdomain.com</a> </li>
                </ul>
  ...
  <!-- Divider: Divider -->
  <section class="parallax divider layer-overlay overlay-dark-7" data-bg-img="http://placehold.it/1920x1280" data-parallax-ratio="0.4">
    <div class="container pt-80 pb-90">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center">
          <a href="https://www.youtube.com/watch?v=kt-4lJs_8fE" data-lightbox-gallery="youtube-video"><img src="images/play-button/s11.png" alt=""></a>
          <h3 class="text-white font-38 font-weight-700 mt-10 mb-0">Faisons une <span class="text-theme-colored2">Visite</span> vidéo et voyons nos activités <span class="text-theme-colored2">Récentes</span></h3>
          <!-- Mailchimp Subscription Form-->
          <form id="mailchimp-subscription-form2" class="newsletter-form max-width-535 mt-10">
            <label for="mce-EMAIL"></label>
            <div class="input-group">
              <input type="email" id="mce-EMAIL" data-height="45px" class="form-control input-lg" placeholder="Votre email" name="EMAIL" value="">
              <span class="input-group-btn">
                <button type="submit" class="btn btn-colored btn-theme-colored2 btn-lg m-0" data-height="45px">Soumettre</button>
              </span>
            </div>
          </form>
  ...
  <section class="bg-silver-light">
    <div class="container pt-70 pb-30">
      <div class="section-title">
        <div class="row">
          <div class="col-md-12">
            <h2 class="text-uppercase title mb-0">Nos <span class="text-theme-colored2">Étudiants </span>Disent</h2> 
            ...
            <div class="item">
              <div class="testimonial pt-10">
                <div class="testimonial-content">
                  <p class="mt-0 font-16">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas vel sint, ut. Quisquam doloremque minus possimus eligendi dolore ad.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas vel sint, ut. Quisquam doloremque minus possimus eligendi dolore ad.Lorem ipsum dolor sit</p>
                </div>
                <div class="testimonial-details mb-0 mr-0">
                  <img alt="" src="http://placehold.it/55x55" class="img-thumbnail img-circle pull-left mr-15 mt-15" width="42">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4">
            <article class="post mb-sm-30">
              ...
              <div class="post-description border-1px p-20">
                <a href="#"><h3 class="post-title font-weight-600 mt-0 mb-15">Programing Festival 2017</h3></a>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo provident neque deleniti eos dicta possimus dolores</p>
              </div>                
              <div class="post-meta">
                <ul class="list-inline pull-left flip">
                  <li><i class="lnr lnr-users text-theme-colored2 font-20"></i>By Admin</li>
                </ul>
                <a href="#" class="text-theme-colored2 font-14 text-gray-darkgray pull-right flip">Read More</a>
              </div>
            </article>
          </div>
          <div class="col-sm-6 col-md-4">
            <article class="post mb-sm-30">
              ...
              <div class="post-description border-1px p-20">
                <a href="#"><h3 class="post-title font-weight-600 mt-0 mb-15">Annual Campus Seminar</h3></a>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo provident neque deleniti eos dicta possimus dolores</p>
              </div>                
              <div class="post-meta">
                <ul class="list-inline pull-left flip">
          ...
          <div class="col-sm-6 col-md-4">
            <article class="post mb-sm-30">
              ...
              <div class="post-description border-1px p-20">
                <a href="#"><h3 class="post-title font-weight-600 mt-0 mb-15">Programming Contest</h3></a>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo provident neque deleniti eos dicta possimus dolores</p>
              </div>                
              <div class="post-meta">
                <ul class="list-inline pull-left flip">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="owl-carousel-6col clients-logo transparent text-center">
            <div class="item"> <a href="#"><img src="http://placehold.it/170x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/170x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/170x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/170x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/169x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/170x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/170x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/170x50" alt=""></a></div>
            <div class="item"> <a href="#"><img src="http://placehold.it/169x50" alt=""></a></div>
